<?
	...
	$sql = "select bno, adviser, customer, saved_time from rsp where saved_date = '$date' and phone_number = '$_SESSION[phone_number]' order by `bno` desc";
    ...
    <div data-role="page">
		...
		<div data-role="content">
			<ul data-role="listview" data-inset="true">
				<li data-divider="true" style="background-color: #2f64a5; color: white;"><? echo "$date" ?></li>
				<?
