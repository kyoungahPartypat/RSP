...
<script language='javascript'>
	function menu_select() {
		if (product_list.menu.value == 'CB01') { location.replace("Personal_B.php?code=body"); }
	}	
</script>
<script>
...
<?		
	if(!strcmp($code, 'body')) {
		$sql = "select * from product_list where small_class LIKE '바디용품'";
	}
        ...
        <div data-role="header" data-position="fixed" style="background-color: #ffc240; color: white;">
            ...
            <div data-role="navbar">
                <ul class="header_ul">
                    ...
                    <li><a href="Personal_B.php?code=body" class="ui-btn-active">바디</a></li>
                ...
                <div class="list_wrap">
					<div class='sel'>
						<select name = "menu" onChange="javascript:menu_select()">
							<option value='CB01' <? if(!strcmp($code, 'body')) { echo "selected='selected'"; } ?>>바디용품 (<? echo "$count[0]"?>)</option>
						</select>
					</div>
                    <?
